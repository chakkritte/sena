...
from sena.providers.anthropic import AnthropicProvider
from sena.providers.gemini import GeminiProvider
from sena.providers.ollama import OllamaProvider
...
class ProviderRegistry:
    ...
    @classmethod
    def create(cls, name: str, config: SenaConfig | None = None) -> BaseProvider:
        cfg = config or SenaConfig()
